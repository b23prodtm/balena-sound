...
* Add btspeaker function DockerHub build snd_usb_audio > ad2p-sink > btspeaker Using third party snd_usb_audio card as first device with Alsa play Deployment scripts to DockerHub Service keep alive Readme and guidelines Continous Integration [Tiana Rakoto Arimanana]
